      ...
      <body className="min-h-dvh bg-paper font-sans text-ink">
        <div className="isolate flex min-h-dvh flex-col">
          <a
            ...
            className="fixed right-4 top-4 z-50 inline-flex items-center gap-2 rounded-full border border-ink/10 bg-paper/80 p-2 text-sm font-medium text-ink shadow-sm backdrop-blur transition hover:border-ink/20 hover:bg-paper sm:right-6 sm:top-6 sm:px-3.5 sm:py-1.5"
          >
            <svg
              viewBox="0 0 24 24"
              aria-hidden="true"
